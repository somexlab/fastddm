...
function(CUDA_SELECT_NVCC_ARCH_FLAGS out_variable)
  ...
  foreach(arch ${cuda_arch_bin})
    if(arch MATCHES "([0-9]+)\\(([0-9]+)\\)")
      ...
      list(APPEND nvcc_flags -arch=sm_${CMAKE_MATCH_1})
      list(APPEND nvcc_archs_readable sm_${CMAKE_MATCH_1})
    else()
      # User didn't explicitly specify ARCH for the concrete CODE, we assume ARCH=CODE
      list(APPEND nvcc_flags "-arch=sm_${arch}")
...
################################################################################################
# Function for selecting GPU architectures for nvcc based on CUDA architectures from parameter list
# Usage:
#   CUDA_SELECT_NVCC_ARCH(out_variable [list of CUDA archs])
function(CUDA_SELECT_NVCC_ARCH out_variable)
  set(CUDA_ARCH_LIST "${ARGN}")
  ...
  foreach(arch ${cuda_arch_bin})
    if(arch MATCHES "([0-9]+)\\(([0-9]+)\\)")
      # User explicitly specified ARCH for the concrete CODE
      list(APPEND nvcc_flags ${CMAKE_MATCH_1})
      list(APPEND nvcc_archs_readable ${CMAKE_MATCH_1})
    else()
      # User didn't explicitly specify ARCH for the concrete CODE, we assume ARCH=CODE
      list(APPEND nvcc_flags "${arch}")
      list(APPEND nvcc_archs_readable sm_${arch})
    endif()
  endforeach()
