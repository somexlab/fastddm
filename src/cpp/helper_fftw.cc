...
/*
    Create the fftw plan for the fft2 of input (single precision).
 */
                                   ...
                                   size_t nt)
{
    ...
    // Create the fft2 plan
    fftwf_plan plan = fftwf_plan_many_dft_r2c(rank,
                                              n,
                                              howmany,
                                              input,
                                              inembed,
...
/*
    Create the fftw plan for the fft of input (single precision).
 */
                                  ...
                                  size_t N)
{
    ...
    // Create the fft2 plan
    fftwf_plan plan = fftwf_plan_many_dft(rank,
                                          n,
                                          howmany,
